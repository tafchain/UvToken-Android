...
import com.yongqi.wallet.net.ApiExceptionUtil
...
abstract class ApiInResponse<T>(val context: Context) : Observer<InchResponseWrapper> {
...
//        }
    ...
    // 上游流下了的数据
    override fun onNext(t: InchResponseWrapper) {
        success(t.address)
