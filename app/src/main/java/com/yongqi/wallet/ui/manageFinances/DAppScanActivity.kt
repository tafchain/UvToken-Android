package com.yongqi.wallet.ui.manageFinances
...
class DAppScanActivity : BaseActivity<ActivityScanQrBinding, ScanQrViewModel>(), QRCodeView.Delegate {
...
//        mZXingView.startCamera(Camera.CameraInfo.CAMERA_FACING_FRONT); // 打开前置摄像头开始预览，但是并未开始识别
    ...
    override fun onScanQRCodeSuccess(result: String?) {
        ...
        if (result.startsWith("http") || result.startsWith("https")) {
            startActivity(Intent(this,FinancialManagementWebViewActivity::class.java).putExtra("url",result).putExtra("title",""))
            finish()
            return
        }
        ...
        if (mIntentType == "intent_type_transfer") {
            ...
            startActivity(Intent(this,DAppScanActivity::class.java)
