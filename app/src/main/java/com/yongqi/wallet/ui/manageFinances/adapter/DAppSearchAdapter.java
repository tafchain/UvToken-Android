...
public class DAppSearchAdapter extends BaseQuickAdapter<DAppDataBean, BaseViewHolder> {
    public DAppSearchAdapter(int layoutResId, @Nullable List<DAppDataBean> data) {
