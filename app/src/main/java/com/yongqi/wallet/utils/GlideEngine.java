...
public class GlideEngine implements ImageEngine {
     ...
     * @param width     指定的宽度
     */
    public static void loadImageWrapHeight(Context context, Integer resourse, ImageView imageView, int width) {//, LoadCallBack loadCallBack
        if (context == null) {
            return;
        }
...
//                        loadCallBack.onLoadSuccess();
    ...
    public void loadImage(@NonNull Context context, @NonNull String url, @NonNull ImageView imageView) {
        Glide.with(context)
                .load(url)
                .error(R.drawable.ic_dapp_error)
                .into(imageView);
    }
