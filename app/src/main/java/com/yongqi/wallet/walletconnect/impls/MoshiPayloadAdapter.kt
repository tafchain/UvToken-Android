package com.yongqi.wallet.walletconnect.impls

import com.squareup.moshi.Json
import com.squareup.moshi.Moshi
import com.squareup.moshi.Types
import com.yongqi.wallet.walletconnect.Session
import com.yongqi.wallet.walletconnect.types.*
...
class MoshiPayloadAdapter(moshi: Moshi) : Session.PayloadAdapter {
    ...
    private fun Map<String, *>.toSendTransaction(): Session.MethodCall.SendTransaction {
        ...
        val gas = data["gas"] as? String
        return Session.MethodCall.SendTransaction(getId(), from, to, nonce, gasPrice, gasLimit, value, txData,gas)
    }
